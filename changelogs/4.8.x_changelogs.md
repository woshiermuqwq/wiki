...
-   修复了 some 漏洞s with the Wearing condition
-   修复了 some 漏洞s with item NBT
-   修复了 some 漏洞s with shootFireball
-   Fixed creeper damage being modified when it shouldn't
-   修复了 some 漏洞s with targeters
-   修复了 some 问题s with the prison mechanic