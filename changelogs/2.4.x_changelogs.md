...
-   修复了 various spawner 问题s with duplicating mobs
-   修复了 warmup on spawners 不生效的问题 correctly
...
-   Fixed issue preventing MythicMobs from loading on certain 1.7 and
    1.8 servers
-   修复了 sound effects throwing 错误s on 1.7 and 1.8 servers
...
-   修复了 inheritance 问题 switching between Location & Entity
    targeters
-   Fixed Slime and Magma Cubes not spawning at all
-   修复了 the ShootPotion mechanic 不生效的问题 at all
-   修复了 several 问题s with mob spawns
...
-   添加了 the **Shulker** as 支持ed MythicMob.
...
-   修复了 message variables 不生效的问题 on disguise names
-   Fixed compability with items generated by MythicMobs and
    *Shopkeepers*
-   修复了 command mechanic 不生效的问题 when using &lt;target.&gt;
    variables
-   修复了 various 空指针异常s
-   Fixed all zombie types spawning as zombie villagers when using 1.9
-   修复了 various 问题s revolving around the new random spawning system
    using *Action: add*
-   修复了 various 问题s from 2.3.0