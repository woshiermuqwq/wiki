...
-   修复了 a 漏洞 causing spawners to sometimes spawn multiple mobs
-   修复了 colors 不生效的问题 in certain disguise names
...
-   修复了 various 问题s with spawners
-   Fixed compatibility-related strings not parsing new variables
    correctly.
-   修复了 the Rally skill 不生效的问题 on certain mob types
...
-   Added more error checking on load
-   修复了 a couple NullPointerException 错误s occuring on certain
    versions of Spigot
...
-   修复了 some 问题s with the title skill
...
-   Fixed NPE caused by &lt;trigger&gt; variables in skills executed
    without a trigger
-   修复了 circular dependency 问题 involving SkillAPI and BetonQuest
...
-   修复了 Shoot skill throwing 错误s and not properly applying damage.
-   修复了 NPE 错误 thrown on certain disguises with certain display
    names
-   修复了 a couple disguise 错误s, added some error catching
-   Fixed NPE caused by @TargetLocation targeter when mob is using
    threat
-   修复了 some variables 不生效的问题 in mob names
-   修复了 certain trigger variables 不生效的问题 correctly on a mob's
    death
...
#### Bug Fixes / Other
      ...
      * 修复了 a calculation 错误 in Threat Tables caused by players zoning to a different world right as a threat tick occurs.
      * 修复了 some 错误s with the Fireball skill not always being fired towards the target
      ...
      * 修复了 a calculation 错误 in ThreatTables caused by players zoning to a different world at the same moment a threat tick occurs
      ...
      * 修复了 the Mount skill 不生效的问题 correctly if the rider was loaded before the mount
