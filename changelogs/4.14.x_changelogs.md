...
- 修复了 an 问题 with MythicMobs trying to remove players
- Fixed setowner and removeowner modifying mob health
- 修复了 an 问题 with randomspawner disabling MM if a biome is not valid.
- Fixed maxdistance attribute in shoot mechanic and also added placeholder support to it
- 修复了 an 问题 with giveitem mechanic
...
- 修复了 reloading 错误 with some conditions
...
- 修复了 MobsInRadius condition 不生效的问题 in RandomSpawns
- 修复了 targeting 问题s with auras
- Fixed `Options.PreventSlimeSplit`
- 修复了 precision 问题 with VariableAdd and VariableSubtract (#531)
- Fixed PlayerWithin-type conditions to ignore creative/spectator players
- 修复了 an 问题 with inline skills/conditions needing space before `]`