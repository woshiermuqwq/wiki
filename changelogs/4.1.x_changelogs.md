...
-   修复了 mythicmobs.command.\* 不生效的问题 for command perms
-   Fixed BossBar not going away when a mob despawns naturally
-   修复了 item amounts 不生效的问题 correctly
-   修复了 several 错误s with commands
-   修复了 chance 不生效的问题 properly in Drop Tables
...
-   修复了 various skill mechanic 空指针异常s
...
-   修复了 some 问题s with spawner behavior
-   修复了 several commands 不生效的问题 in the console
-   修复了 several other 问题s with commands
-   修复了 ItemSpray effect 不生效的问题 with vanilla items
-   Fixed variables and random numbers not parsing in item lore
-   修复了 @TargetLocation 不生效的问题 as expected for players
