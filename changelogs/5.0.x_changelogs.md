...
- 修复了 crashing 问题 with mob types that no longer exist
- 修复了 several major compatibility 问题s
...
- 修复了 BlockWave 不生效的问题 on 1.18.2
- 修复了 color code 问题s
- 修复了 some placeholder 空指针异常s
- Fixed message formatting
- 修复了 some blackmask effect 问题s
- 修复了 vanilla mobs 不生效的问题 with spawn command
...
- 修复了 display 问题s with item drop type
...
- 修复了 some 问题s with GoToLocation AI goal
- Fixed RandomSpawns affecting vanilla mob spawning rate
- Fixed bug with HolographicDisplays support
- 修复了 lag 问题s from ProtocolLib/ removed PL features since they aren't really relevant anymore
- Fixed &r
...
- 添加了 `min(x, y)`, `max(x, y)`, `atan2(y, x)` math functions. You can see all the 支持ed operators and functions in [Math](/Skills/Math), and you can make suggestions to add more operators and functions to [gitlab](https://git.mythiccraft.io/mythiccraft/MythicMobs/-/issues)
