...
-   修复了 a couple Legacy skills 不生效的问题 anymore
-   修复了 Custom KillMessages 不生效的问题 when killed by projectiles
-   Fixed head items not displaying their display names
-   修复了 a ThreatTable target event 错误 could spam the console
-   修复了 numerous other 漏洞s
