...
-   修复了 several 漏洞s with placeholders
-   修复了 number ranges 不生效的问题 in drops
...
----
 ...
 添加了对以下内容的支持： all 1.14 mob types. 
...
-   修复了 some 漏洞s with serialization
...
-   修复了 a bunch of 错误s related to world unloading
-   修复了 despawn event throwing an async 错误
-   修复了 despawning 错误s on shutdown
...
-   修复了 an 错误 with recursive drops
-   修复了 several variable-related 漏洞s
-   Fixed custom API drops not rolling amounts correctly
-   修复了 various 错误s with Random Spawns
-   Fixed particle effects appearing in the wrong world
-   修复了 delayed skills throwing 错误s when the world was unloaded
-   Fixed toggleLever not obeying the set duration
-   修复了 another 错误 with shootpotion
