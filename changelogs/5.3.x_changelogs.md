...
- 添加了 `bulletOffset` 选项 for bullets (defaults to 1.8)

Bugs / Other
------------
- 添加了 placeholder 支持 to teleport mechanic
- 修复了 loading 问题 on 1.18
...
- 修复了 blockType and blockIgnore targeter filters 不生效的问题 unless a limit is set closes #1182
- Fixed ThreatTables targeting same-faction players
- 修复了 `setVariableLocation` mechanic 不生效的问题 with non-entity targets
- 修复了 nonsensical 错误 in onDamaged aura
- 修复了 hugSurface projectiles 损坏的问题 with highAccuracy enabled
- 修复了 blockmask 损坏的问题
- Fixed placeholder support in score mechanic 
- 修复了 suicide mechanic 不生效的问题 with PassthroughDamage enabled
- 修复了 PassthroughDamage 不生效的问题 with certain damage types
- 修复了 several 问题s with asParent, asOwner, asTrigger target modifiers
...
- 添加了 Placeholder 支持 for Score and ScoreGlobal conditions
...
- 修复了 several 问题s with Damage mechanic
...
- 修复了 blockmask 错误 when MythicDungeons world unloads
