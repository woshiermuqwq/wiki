...
-   修复了 PotionMechanic overwrite=true 不生效的问题 on 1.15
-   修复了 offset 不生效的问题 in speak mechanic
-   修复了 serialization 错误 with spawn location and goToSpawn AI
    goal
...
-   修复了 GoToOwner goal 错误 when player owner changes worlds
...
-   修复了 villager trade results 不生效的问题 with multiple amounts
-   修复了 RemoveAura mechanic 不生效的问题 with targets
-   Fixed dusk condition logic being backwards
-   Fixed remount mechanic running async
-   修复了 custom AI 错误s on 1.13
...
-   添加了 placeholder 支持 to "shoot" and "volley" mechanics.
-   添加了 placeholder 支持 in the 'setname' mechanic.
...
### NEW: teleportto
    ...
    *添加了 'teleportto{}' mechanic, with 支持 for relative teleportation.
    - teleportto{m=relative;c=0,1,0} (teleports the target 1 block above its' current location)
    - 
    * 添加了对以下内容的支持： directional teleportation:
...
-   添加了 native 支持 for latest MMOItems/MMOCore
...
-   修复了 several placeholder/math 漏洞s.
-   improved 1.15.1/1.15.2 compatibility
-   修复了 several spawner related 漏洞s.
...
-   修复了 Options.PassthroughDamage 不生效的问题 with projectiles.
-   修复了 a bullettype material 错误
-   Fixed Parrots
...
-   修复了 an 空指针异常 with CreatureSpawnEvent
...
-   修复了 compatibility 错误 with HolographicDisplays
