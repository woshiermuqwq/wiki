...
-   添加了 the **Vindication Illager** aka **Vindicator** as 支持ed
    MythicMob.

#### NEW: Evoker

-   添加了 the **Evocation Illager** aka **Evoker** as 支持ed
    MythicMob.

#### NEW: Vex

-   添加了 the **Vex** as 支持ed MythicMob.

#### NEW: Llama

-   添加了 the **Llama** aka **Llama** as 支持ed MythicMob.

### Effects

#### NEW: SPIT

-   添加了对以下内容的支持： the **SPIT** particles.

#### NEW: TOTEM

-   添加了对以下内容的支持： the **TOTEM** particles.

Other / Bugfixes
----------------

-   修复了 Potion item config 不生效的问题 for SPLASH\_POTION and
    TIPPED\_ARROW.
...
-   修复了 enchanted books 不生效的问题 properly
-   Fixed mobs being able to attack their owners
-   Fixed AI goal goToOwner not navigating vertically up blocks
-   修复了 ConcurrentModification 问题 with Projectile mechanic
-   修复了 ConcurrentModification 问题 with Missile mechanic
