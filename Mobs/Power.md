...
技能 战力 is an 属性 available to all 技能 that increases the potency of 技能. Base 属性 set in the 生物 configuration 不会 be affected by 战力 等级. It is primarily used as a way to increase 技能 战力 with a 生物 等级, and can 仅 be applied using [等级 Modifiers](/生物/等级). Some 技能 have certain 属性 that can be multiplied by 战力 等级.
...
| 技能 | 属性 | 战力 等级 效果 |
| ------------- | ----------| ----------------------------------------------------- |
| [basedamage](/技能/技能/basedamage) | {multiplier=M} | 伤害 = M * 战力 |
| [consume](/技能/技能/consume) | {伤害=D} | 伤害 = D * 战力 |
| [consume](/技能/技能/consume) | {heal=H} | heal = H * 战力 |
| [伤害](/技能/技能/伤害) | {数量=A} | 伤害 = A * 战力 |
| [leap](/技能/技能/leap) | {速度向量=V} | 速度向量 = V * ( 1 + 战力 * 0.1 ) |
| [弹射物](/技能/技能/弹射物) | {速度向量=V} | 速度向量 = V * 战力 |
| [弹射物](/技能/技能/弹射物) | {maxrange=MR} | maxrange = MR * 战力 |
| [制导弹射物](/技能/技能/制导弹射物) | {速度向量=V} | 速度向量 = V * 战力 |
| [制导弹射物](/技能/技能/制导弹射物) | {maxrange=MR} | maxrange = MR * 战力 |
