...
| 半径    | r         | The 半径 of the blockmask effect                                   | 0       |
| radiusy   | ry        | The y component of the 半径                                        | `半径`|
...
| occ       | o, oc     | If onlyair is used, 目标 transparent blocks as well                | true    |
...
Creates a layer of ice underneath the feet of all players within a 50 block 半径, causing them to have a constantly slippery walk.
...
Will forcibly reverse all effects created by the blockmask effect in the specified 半径. The blockunmask effect doesn't have any syntax options except for “半径”.
