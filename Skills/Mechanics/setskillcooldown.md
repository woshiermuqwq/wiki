...
> If used to set the cooldown of the metaskill the 技能 is in a delay of at least `0` between the execution of the metaskill and the 技能 必须 used

> The target Metaskill needs to have a Cooldown option to begin with. If you do not wish for it to have a Cooldown but you still want to use this 技能 to set it dynamically, use `Cooldown: 0`
...
```
> How to use the 技能 if you intend to set the cooldown of the calling metaskill
