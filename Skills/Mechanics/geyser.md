## 描述
Causes a geyser of liquid to shoot out of the ground at 目标实体 or location.
...
| height    | h         | How high the geyser will go. 将被设为 to *at least* 1 even if specified otherwise. | 3       |
