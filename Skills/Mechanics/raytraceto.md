## 描述
Traces a ray to the 目标, like the [Raytrace](/skills/技能/raytrace) 技能, but with additional attributes regarding the start and end position of the ray.
...
| fromorigin| fo        | If they ray should start from the 原点 of the 技能             | false   |
| useeyelocation | uel  | If they ray should start from the eye location of the 施法者         | false   |
