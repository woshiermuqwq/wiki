## 描述
Sets a [variable](/skills/variables). Variables 可以 permanent or
temporary, and 可以 used in conjunction with conditions or
...
| scope     | s         | The [scope](/skills/variables#variable-scopes) of the variable, e.g. where the variable 将会 located                                                                       | SKILL<!--type:VariableScope-->|
...
Other variables 可以 stored inside a int/float variables.
```yaml
VariableSend:
  Skills:
