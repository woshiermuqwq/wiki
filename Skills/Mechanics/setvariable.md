...
temporary, and 可用于 conjunction with 条件 or
...
| scope     | s         | The [scope](/skills/variables#variable-scopes) of the variable, 例如 where the variable will be located                                                                       | SKILL<!--type:VariableScope-->|
| save      |           | 是否 the variable should save between reloads, reboots and disconnects. Does not apply to SKILL-scoped variables                                                            | false   |
...
## 示例
In this example, the 目标 players would only hear growling from any
