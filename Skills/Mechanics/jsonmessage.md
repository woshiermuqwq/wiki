## 描述
Sends a json-format chat message to the 目标 player(s). JSON-messages
are capable of hover-events, click events and some other perks that are
unavailable in the other message 技能. They also support [color
...
the /mm signal command to create interactive quest 生物. This example
would send the signal &lt;signal&gt; to the 生物 casting the json-message
