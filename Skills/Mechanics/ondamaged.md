...
| damagemodifiers | damagemods, damagemod | Allows the aura to apply damage modifiers. Also accepts a list, as shown in the example. Placeholders 可以 used as the modifier's amount (**Premium only**). |   |
| deflectProjectiles | deflect, reflect | Whether projectiles 应当 deflected               | false  |
